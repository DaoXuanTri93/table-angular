 ...
 */
export const KEY_USER = '7b062ca2-731e-4162-985e-e2b5d45e3765';
/**
 ...
 */
export const LINK_API = environment.URL_API;
/**
 ...
 */
export const LIST_LANGUAGE = environment.URL_LANGUAGES.split(',');
/**
...
export const LANGUAGE =
  LIST_LANGUAGE.indexOf(location.hash.split('/')[1]) > -1
    ...
    : (localStorage.getItem('i18nextLng') ?? environment.LANGUAGE);
/**
 * The format of the date used in the application.
 */
export const FORMAT_DATE = environment.APP_FORMAT_DATE;
/**
...
export const C_API = {
  ...
  Code: '/api/v1/Member/member-profile',
