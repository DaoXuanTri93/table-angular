 ...
 * @property {(data: { value: any; values: any;  }) => any} [convert] - Function to convert the form item value.
...
export interface IFormItem {
  ...
  onBlur?: (props: { value: any; form: FormApi<any, any>; name: any }) => void;
  // render?: (props: { values: any; index: number }) => VNode;
  notDefaultValid?: boolean;
  convert?: (data: { value: any; values: any }) => any;
  ...
  text?: {
    mask?: any;
    addonBefore?: TemplateRef<unknown>;
    addonAfter?: TemplateRef<unknown>;
  };
  addable?: {
    textAdd?: string;
